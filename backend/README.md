...
## Project Structure
    ...
    ├── dvdemocbmarketingno_37490  # Django project configurations
...
1. Clone this repo and `cd dvdemocbmarketingno_37490`
...
2. Clone this repo and `cd dvdemocbmarketingno_37490`
